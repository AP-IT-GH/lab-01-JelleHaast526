...
public class CubeAgentCoin : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        GameObject coin = GameObject.FindGameObjectWithTag("Reward");

        sensor.AddObservation(coin != null ? coin.transform.localPosition.x : 0f);
    }
